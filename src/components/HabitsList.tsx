...
export function HabitsList({ date, completed }: HabitsListProps) {
    ...
    return (
        <>
            ...
            <div className="mt-6 flex flex-col gap-3">
                <Checkbox.Root
                    checked={completed >= 2 ? true : false}
                    disabled={isDateInPast}
                    className="flex items-center gap-3 group focus:outline-none disabled:cursor-not-allowed"
                >
                    <div
            ...
            <div className="mt-6 flex flex-col gap-3">
                <Checkbox.Root
                    checked={completed >= 3 ? true : false}
                    disabled={isDateInPast}
                    className="flex items-center gap-3 group focus:outline-none disabled:cursor-not-allowed"
                >
                    <div
            ...
            <div className="mt-6 flex flex-col gap-3">
                <Checkbox.Root
                    checked={completed >= 4 ? true : false}
                    disabled={isDateInPast}
                    className="flex items-center gap-3 group focus:outline-none disabled:cursor-not-allowed"
                >
                    <div
            ...
            <div className="mt-6 flex flex-col gap-3">
                <Checkbox.Root
                    checked={completed >= 5 ? true : false}
                    disabled={isDateInPast}
                    className="flex items-center gap-3 group focus:outline-none disabled:cursor-not-allowed"
                >
                    <div
